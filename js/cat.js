...
Cat = function(){
  ...
  this.face = new THREE.Mesh(faceGeom,blackMat);
  ...
  this.rightEar = new THREE.Mesh(rightEarGeom, blackMat);
  this.rightEar.position.y = this.faceHeight;
  this.rightEar.position.x = -14;
  this.rightEar.position.z = -1.7;  
  
  this.leftEar = new THREE.Mesh(leftEarGeom, blackMat);
  ...
  this.cheeks = new THREE.Mesh(cheeksGeom, blackMat);
  ...
  this.rightArm = new THREE.Mesh(armGeom,blackMat);
  ...
  this.rightForeArm = new THREE.Mesh(foreArmGeom,blackMat);
  ...
  this.rightKnee = new THREE.Mesh(kneeGeom, blackMat);
  ...
  for (var i = 0; i<this.tailNSegs ; i++){
    var mat = (i<this.tailNSegs-1)? blackMat : whiteMat;
